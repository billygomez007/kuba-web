...
type Data = { plan: { name: string; features: string[] }; provider: string; capabilities: { supportsHostedCheckout: boolean; supportsBillingPortal: boolean; supportsCancellation: boolean; supportsPlanChange: boolean }; subscription: { status: string; currentPeriodEnd: string | null; cancelAtPeriodEnd: boolean; trialEnd: string | null } | null; usage: { employees: Metric; automations: Metric; voiceMinutes: Metric; conversations: Metric } };
