...
const navigationGroups: NavigationGroup[] = [
  ...
  },
  {
    ...
    icon: "◈",
    items: [
      { label: "Marketing Overview", href: "/dashboard/marketing", icon: "◈", permission: "outreach.view" },
      { label: "Campaigns", href: "/dashboard/marketing/campaigns", icon: "▶", permission: "outreach.view" },
      { label: "Content Studio", href: "/dashboard/marketing/content", icon: "✎", permission: "outreach.view" },
      { label: "Content Calendar", href: "/dashboard/marketing/calendar", icon: "□", permission: "outreach.view" },
      { label: "Approvals", href: "/dashboard/marketing/approvals", icon: "✓", permission: "outreach.view" },
      { label: "Audiences", href: "/dashboard/marketing/audiences", icon: "◎", permission: "outreach.view" },
      { label: "Assets", href: "/dashboard/marketing/assets", icon: "▧", permission: "outreach.view" },
      { label: "Social accounts", href: "/dashboard/marketing/social", icon: "↗", permission: "outreach.view" },
      { label: "Analytics", href: "/dashboard/marketing/analytics", icon: "▥", permission: "outreach.view" },
    ],
  },
  {
...
const navigationPermissions: Record<string, string> = {
  ...
  "/dashboard/marketing": "outreach.view",
  "/dashboard/marketing/campaigns": "outreach.view",
  "/dashboard/marketing/content": "outreach.view",
  "/dashboard/marketing/calendar": "outreach.view",
  "/dashboard/marketing/approvals": "outreach.view",
  "/dashboard/marketing/audiences": "outreach.view",
  "/dashboard/marketing/assets": "outreach.view",
  "/dashboard/marketing/social": "outreach.view",
  "/dashboard/marketing/analytics": "outreach.view",
...
const navigationCapabilities: Record<string, string> = {
  ...
  "/dashboard/marketing": "outreach.campaigns",
  "/dashboard/marketing/campaigns": "outreach.campaigns",
  "/dashboard/marketing/content": "outreach.campaigns",
  "/dashboard/marketing/calendar": "outreach.campaigns",
  "/dashboard/marketing/approvals": "outreach.campaigns",
  "/dashboard/marketing/audiences": "outreach.campaigns",
  "/dashboard/marketing/assets": "outreach.campaigns",
  "/dashboard/marketing/social": "outreach.campaigns",
  "/dashboard/marketing/analytics": "outreach.campaigns",
