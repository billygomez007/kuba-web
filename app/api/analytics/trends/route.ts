...
export async function GET(
  ...
  try {
    ...
    if (!hasCapability(await getBusinessEntitlements(business.businessId), "intelligence.sales")) {
      return NextResponse.json({ error: "Sales trend intelligence requires a higher plan.", code: "FEATURE_NOT_ENTITLED", upgradeRequired: true, requiredPlan: "pro" }, { status: 403 });
    }
