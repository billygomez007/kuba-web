...
export const ACTION_META: Record<AIAction, { kind: ActionKind; label: string; description: string }> = {
  ...
  read_marketing_campaigns: { kind: "read", label: "View marketing campaigns", description: "Read native tenant-scoped Marketing campaigns." },
  read_marketing_content: { kind: "read", label: "View marketing content", description: "Read native tenant-scoped Marketing content drafts." },
