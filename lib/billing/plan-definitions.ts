...
export type Capability =
  ...
  | "outreach.campaigns" | "marketing.native"
...
// Approved canonical matrix (2026-09): Starter is "your first AI employee" —
// core conversations/appointments/customers/basic analytics ship from day
// one so a solo Receptionist employee is actually usable, not a half product.
// Leads/Sales moves to Growth-and-up instead (Growth = "your AI customer and
// sales team"), matching that Starter has no Sales AI employee at all.
const starterCapabilities: Capability[] = ["command_center.basic", "ai_workforce.core", "customer_ops.core", "customer_ops.inbox", "customer_ops.customers", "customer_ops.followups", "customer_ops.conversations", "customer_ops.appointments", "intelligence.basic", "integrations.core", "integrations.communication", "business_brain.core", "business_brain.sources", "admin.team_staff", "admin.billing"];
const growthCapabilities: Capability[] = [...starterCapabilities, "marketing.native", "customer_ops.leads", "ai_workforce.builder", "ai_workforce.teams", "ai_workforce.deployment", "ai_workforce.monitoring", "customer_ops.handoffs", "customer_ops.tickets", "business_ops.core", "business_ops.tasks", "business_ops.approvals", "business_ops.automations", "business_brain.documents", "business_brain.memory", "business_brain.instructions"];
const proCapabilities: Capability[] = [...growthCapabilities, "customer_ops.ai_assist", "outreach.campaigns", "ai_workforce.orchestration", "ai_workforce.performance", "ai_workforce.voice", "ai_workforce.simulator", "ai_workforce.marketplace", "human_workforce.core", "human_workforce.hr", "human_workforce.attendance", "human_workforce.leave", "human_workforce.payroll", "human_workforce.teams", "business_ops.workflows", "business_ops.documents", "business_ops.alerts", "intelligence.advanced", "intelligence.sales", "intelligence.customer", "intelligence.ai_workforce", "intelligence.human_workforce", "intelligence.operations", "intelligence.reports", "integrations.social", "integrations.calendar", "integrations.payments", "integrations.accounting", "integrations.crm", "integrations.external_apps", "integrations.developer_api", "business_brain.management"];
