...
const rawEmployeeCatalog: RawCatalogEntry[] = [
  ...
  },
  {
    ...
    category: "Operations",
    description: "Schedules appointments, manages availability, and sends reminders.",
    capabilities: ["Schedule appointments", "Manage availability", "Send reminders", "Handle bookings"],
    icon: "◈",
